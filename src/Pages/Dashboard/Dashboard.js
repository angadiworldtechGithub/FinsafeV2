    ...
    <div>
      ...
      <div className="date-container">
        <p className="date-para">
          {" "}
          Choose Date - <input className="date" type="date"></input>
        </p>

        <button className="date-button">ROC</button>
        <i className="date-icon">
          <BiRightArrow />
        </i>
        <br></br>
        <button className="date-button">Income Tax</button>
        <i className="date-icon">
          <BiRightArrow />
        </i>
        <br></br>
        <button className="date-button">Form 16</button>
        <i className="date-icon">
          <BiRightArrow />
        </i>
          ...
          <div className="date-flex-right">
            <div className="date-right1">
              <div className="date-flex1">
                Company Name - what ever user enter in company Details it comes
                in this box
              </div>
              <div className="date-flex1">Name -</div>
            </div>
            <div className="date-right1">
              <div className="date-flex1">Name -</div>
              <div className="date-flex1">Name -</div>
