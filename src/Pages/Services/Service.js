    ...
    <div>
       ...
       <div className="flex-child">
          ...
          <h3 className="color_white" style={{fontWeight:'600'}}> 
            <center><b>B2C Services</b></center>
          </h3>

         <p className="color_white">
          Our B2C services include investment planning, estate management services,
          tax planning, and income tax returns. We help individuals achieve their 
          financial goals with expert-level guidance and personalized financial planning.
        </p>
    
         <p className="color_white"> 
         <ul className='service_list'>

            <li><i className="fa-solid fa-circle-check"></i> &nbsp;  Investment planning</li>
            <li><i className="fa-solid fa-circle-check"></i> &nbsp;  Estate management services </li>
            <li><i className="fa-solid fa-circle-check"></i> &nbsp;  Tax Planning</li>
            <li><i className="fa-solid fa-circle-check"></i> &nbsp;  Income tax returns</li>
       ...
       <div className="flex-child1">
        <center><h3>B2C Services</h3></center> 
              ...
              <form action="/">
                       ...
                       <input className="service_input" type="tel" id="Contact" name="Contact" placeholder="Contact Number"></input>
                      ...
                      <select className="service_input" type="text" id="city" name="city" placeholder='Select city' >
