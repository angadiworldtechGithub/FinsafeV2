      ...
      <div className="flex-container">
        <div className="flex-child">
          ...
          <p className="color_white">
            Our B2C services include investment planning, estate management
            services, tax planning, and income tax returns. We help individuals
            achieve their financial goals with expert-level guidance and
          ...
          <p className="color_white">
            <ul className="service_list">
              <li>
                <i className="fa-solid fa-circle-check"></i> &nbsp; Investment
                planning
              </li>
              <li>
                <i className="fa-solid fa-circle-check"></i> &nbsp; Estate
                management services{" "}
              </li>
              <li>
                <i className="fa-solid fa-circle-check"></i> &nbsp; Tax Planning
              </li>
              <li>
